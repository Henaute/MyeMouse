...
class Rotor(QWidget):
    ...
    def __init__(self, nom, parent):
        ...
        if "rotation Nifti" in self.name:
            self.sld.valueChanged.connect(parent.RotateN)
            self.sld.valueChanged.connect(self.updateLabel)
            
        elif "rotation TIFF" in self.name:
            self.sld.valueChanged.connect(parent.RotateT)
            self.sld.valueChanged.connect(self.updateLabel)
...
class MainWindow(QMainWindow):
    ...
    def Save(self, state):
        ...
        beta = np.radians(self.rotTIFF-self.rotNifti)
    ...
    def clickBoutton1(self, state):
        ...
        self.opacity = 1 
        self.SliderOpacity.deleteLater()
        ...
        self.rotNifti = 0
        self.rotTIFF = 0
        self.rotateNifti.deleteLater()
        self.rotateNifti = Rotor("rotation Nifti :{0}°",self)
        self.rotateTIFF.deleteLater()
        self.rotateTIFF = Rotor("rotation TIFF :{0}°",self)
        
        self.layout2.addWidget(self.Zoomer1,1,0)
        #self.layout2.addWidget(QDoubleSpinBox(),1,1)
        self.layout2.addWidget(self.rotateNifti,2,1)
        self.layout2.addWidget(self.Zoomer2,5,0)
        self.layout2.addWidget(self.SliderOpacity,5,1)
        self.layout2.addWidget(self.SliderX2,6,0)
        self.layout2.addWidget(self.affX,6,1)
        self.layout2.addWidget(self.SliderY2,7,0)
        self.layout2.addWidget(self.affY,7,1)
        self.layout2.addWidget(self.rotateTIFF,8,0)
        self.layout2.addWidget(self.Flip,8,1)
    ...
    def RotateN(self,value):
        
        self.rotNifti = value
        self.changed = True
        self.visual()
        
    def RotateT(self,value):
    ...
    def nVolume(self,value):
        ...
        self.nVol = value
        self.Nifti.update(self.slice, self.nVol)
    ...
    def visual(self):
        ...
        if self.changed:
            ...
            if self.rotNifti !=0:
                self.im1 = ndimage.rotate(self.im1, self.rotNifti, reshape=True)
            if self.rotTIFF != 0:
                self.im2 = ndimage.rotate(self.im2, self.rotTIFF, reshape=True)
    ...
    def __init__(self):
        ...
        boutton1 = Boutton('&Clear Settings', self)
        boutton2 = QPushButton('&boutton2')
        boutton3 = Boutton('&Save File', self)

        
        self.output = QLabel()
        self.output.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.output.setFixedSize(1080, 720)
        ...
        """
        self.layout2.addWidget(self.Zoomer1,0,0)
        self.layout2.addWidget(self.volume,0,1)
        self.layout2.addWidget(self.SliderX1,1,0)
        self.layout2.addWidget(self.rotateNifti,1,1)
        self.layout2.addWidget(self.SliderY1,2,0)
        self.layout2.addWidget(self.SliderZ1,2,1)

        self.layout3.addWidget(self.Zoomer2,0,0)
        self.layout3.addWidget(self.SliderOpacity,0,1)
        self.layout3.addWidget(self.SliderX2,1,0)
        self.layout3.addWidget(self.affX,1,1)
        self.layout3.addWidget(self.SliderY2,2,0)
        self.layout3.addWidget(self.affY,2,1)
        self.layout3.addWidget(self.rotateTIFF,3,0)
        self.layout3.addWidget(self.Flip,3,1)
        ...
        self.layout4.addWidget(self.load1,0,0)
        self.layout4.addWidget(self.Check1,0,1)
        self.layout4.addWidget(self.load2,1,0)
        self.layout4.addWidget(self.Check2,1,1)
        self.layout4.addWidget(self.comboBox,2,0,1,2)
        if self.combo:
            self.layout4.addLayout(self.layout2,3,0,1,2)
        else:
            self.layout4.addLayout(self.layout3,3,0,1,2)
        self.layout4.addWidget(self.ZoomerAll,4,0)
        self.layout4.addWidget(self.SliderOpacity,4,1)
        """
        layout6.addWidget(boutton1,0,0)
        layout6.addWidget(boutton2,0,1)
        layout6.addWidget(boutton3,0,2)
        ...
        self.layout2.addWidget(self.rotateNifti,2,1)
        self.layout2.addWidget(self.SliderY1,3,0)
        #self.layout2.addWidget(Rotor("rotation on y"),3,1)
        self.layout2.addWidget(self.SliderZ1,3,1)
        #self.layout2.addWidget(Rotor("rotation on z"),4,1)
        
        self.layout2.addWidget(self.load2,4,0)
        self.layout2.addWidget(self.Check2,4,1)
        self.layout2.addWidget(self.Zoomer2,5,0)
        self.layout2.addWidget(self.SliderOpacity,5,1)
        self.layout2.addWidget(self.SliderX2,6,0)
        self.layout2.addWidget(self.affX,6,1)
        ...
        self.layout2.addWidget(self.ZoomerAll,9,0)
        
        layout5.addWidget(self.output,0,0)
        layout5.addLayout(layout6,1,0)
        
        #layout1.addLayout(self.layout4,0,0)
        layout1.addLayout(self.layout2,0,0)
        layout1.addLayout(layout5,0,1)
